...
class docVerbatimTextTypeSub(supermod.docVerbatimTextType):
    def __init__(self, refid=None, kindref=None, external=None, valueOf_='', mixedclass_=None, content_=None):
        supermod.docVerbatimTextType.__init__(self, mixedclass_, content_)
supermod.docVerbatimTextType.subclass = docVerbatimTextTypeSub
# end class docVerbatimTextTypeSub
    ...
    def buildChildren(self, child_, nodeName_):
        ...
        if child_.nodeType == Node.TEXT_NODE:
            ...
            self.simplesects.append(obj_)
                ...
                nodeName_ == 'verbatim':
            obj_ = supermod.docVerbatimTextType.factory()
            obj_.build(child_)
            self.verbatim.append(obj_)
